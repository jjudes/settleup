...
export default function Home() {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col items-center justify-center p-6 relative overflow-hidden bg-gradient-to-b from-[#d5ead5] to-[#b7dbb7] overscroll-none">
      <MoneyRain />

      <main className="w-full max-w-md z-10">
        <div className="glass rounded-3xl p-5 sm:p-8 mb-8 text-center shadow-2xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight mb-2 text-foreground break-words">Settle Up</h1>
          <p className="text-foreground/70 mb-8 px-2">The easiest way to split expenses with friends.</p>
